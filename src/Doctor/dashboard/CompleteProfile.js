...
const CompleteProfile = (props) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const validRegisterNumbers = ["12345", "23456", "34567", "45678", "56789", "67899", "78999", "89999", "99999"];
        console.log(regNumber)
        if (!validRegisterNumbers.includes(regNumber.trim())) {
            return setRegisterError("Incorrect register number");
        }
                                            ...
                                            <div className="col-md-6 mb-3">
                                                ...
                                                <div className="input-group">
                                                    <input type="text" className="form-control" id="Registration Number"
                                                        ...
                                                        value={regNumber} onChange={handleRegNumberChange} placeholder="E.g 15678" required="" />
